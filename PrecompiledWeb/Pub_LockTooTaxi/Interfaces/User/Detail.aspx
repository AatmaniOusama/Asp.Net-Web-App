 <%@ page title="" language="C#" masterpagefile="~/Interfaces/Shared/MasterPage.master" autoeventwireup="true" inherits="Interfaces_User_Detail, App_Web_bsanhxqr" %>
                ...
                <fieldset class="login" id="fieldset2" style="width: 400px; height: 600px">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="TbObservation"  runat="server" Height="100px" Width="205px"  CssClass="textplaceholder" TextMode="MultiLine"></asp:TextBox>
                            </td>
                        </tr>
                       <%-- <tr>
                            <td>
                            ...
                            <td>
                                <asp:TextBox ID="TbCommentaire"  runat="server" Width="205px" CssClass="textplaceholder" TextMode="MultiLine"></asp:TextBox>
                            </td>
                        </tr>--%>
                    </table>
                </fieldset>
