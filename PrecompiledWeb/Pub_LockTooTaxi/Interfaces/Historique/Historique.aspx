<%@ page title="Historique" language="C#" masterpagefile="~/Interfaces/Shared/MasterPage.master" autoeventwireup="true" inherits="Interfaces_Historique_Historique, App_Web_y1tlwqpm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
            ...
            <asp:TableRow>
            <asp:TableCell>
                <asp:CheckBox ID="CbFiltre" runat="server" AutoPostBack="true" CssClass="button" Checked="true" Text="Afficher les filtres" OnCheckedChanged="CbFiltre_CheckedChanged" />
            </asp:TableCell>
            <asp:TableCell>
            ...
            <asp:TableCell>
             ...
             <asp:TableCell>
              <asp:UpdatePanel ID="UpdatePanel5" runat="server" UpdateMode="Conditional"  >
                <ContentTemplate>
                <asp:ImageButton ID="InsererPointage" ImageUrl="~/Icons/InsererPtge.jpg" runat="server" CssClass="button"  ToolTip="Insérer Pointage" onclick="InsererPointageClick"  />
            </ContentTemplate>
                <Triggers>
             ...
             <asp:TableCell>
                ...
                <ContentTemplate>
                <asp:ImageButton ID="BtnDelete" ImageUrl="~/Icons/DeletePointage.PNG" CssClass="button" runat="server" ToolTip="Supprimer Pointage"  OnClick="BtnDelete_Click"  OnClientClick="return confirm('Etes-vous sûr que vous voulez supprimer ce Pointage ?');" Visible = "false"  />
                </ContentTemplate>
                <Triggers>
                    <asp:AsyncPostBackTrigger ControlID="GridViewEvents" EventName="SelectedIndexChanging" />
                    <asp:AsyncPostBackTrigger ControlID="GridViewEvents" EventName="RowDataBound" />
        ...
        <asp:Panel  id="Panelfilter" runat="server" Visible="true" >
            ...
            <td>
                ...
                <asp:TextBox ID="TbMatriculeFiltre" runat="server" Width="80%"    CssClass="text" ></asp:TextBox>
                 <ajaxToolkit:FilteredTextBoxExtender ID="ftbe1" runat="server" TargetControlID="TbMatriculeFiltre" ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz1234567890" />
            </td>
            <td>

                N°Permis<br />
                <asp:TextBox ID="TbNPermis" runat="server" Width="80%"   CssClass="text"  ></asp:TextBox>
                 <ajaxToolkit:FilteredTextBoxExtender ID="ftbe2" runat="server" TargetControlID="TbNPermis" ValidChars="1234567890" />
            </td>
            <td>

                N°Taxi<br />
                <asp:TextBox ID="TbNTaxi" runat="server" Width="80%"   CssClass="text" ></asp:TextBox>
                 <ajaxToolkit:FilteredTextBoxExtender ID="ftbe3" runat="server" TargetControlID="TbNTaxi" ValidChars="1234567890" />
            </td>
            <td>

                Code Refus<br />
                <asp:TextBox ID="TbCodeRefus" runat="server" Width="80%"   CssClass="text" ></asp:TextBox>
                 <ajaxToolkit:FilteredTextBoxExtender ID="ftbe4" runat="server" TargetControlID="TbCodeRefus" ValidChars="1234567890" />
            </td>
            ...
            <td>
                ...
                <asp:TextBox ID="TbNomFiltre" runat="server" Width="80%"   CssClass="text" ></asp:TextBox>
                 <ajaxToolkit:FilteredTextBoxExtender ID="ftbe5" runat="server" TargetControlID="TbNomFiltre" ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz -" />
            </td>
            <td>

                Immatriculation<br />
                <asp:TextBox ID="TbImmatriculation" runat="server" Width="80%"   CssClass="text"  ></asp:TextBox>
             <ajaxToolkit:FilteredTextBoxExtender ID="ftbe6" runat="server" TargetControlID="TbImmatriculation" ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz1234567890-" />
            </td>
            <td>

                Type Taxi<br />
                <asp:DropDownList ID="DDLTypeTaxi" runat="server" Width="80%" CssClass="text" 
                    AutoPostBack="True">
                </asp:DropDownList>
            ...
            <td>
                ...
                <asp:TextBox ID="TbMatriculeAgent" runat="server" Width="80%"  CssClass="text"  ></asp:TextBox>
                 <ajaxToolkit:FilteredTextBoxExtender ID="ftbe7" runat="server" TargetControlID="TbMatriculeAgent" ValidChars="1234567890" />
            </td>
        ...
        <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Always"  >
            <ContentTemplate>
                    ...
                    <asp:GridView ID="GridViewEvents" 
                    runat="server" Width="190%"  Height="100%"
                    ...
                    onselectedindexchanging="GridViewEvents_SelectedIndexChanging" 
                    
                    
                    AllowSorting="true"
                    OnSorting="Historique_Sorting"
                    ...
                    <HeaderStyle CssClass="GridViewHeaderStyle" />
                        ...
                        <Columns>
                            <asp:ButtonField ButtonType="Link" Text="" CommandName="Select" HeaderStyle-Width="0px" HeaderStyle-BackColor="White" HeaderStyle-BorderColor="White" ItemStyle-Width="0px" ItemStyle-BackColor="White" ItemStyle-BorderColor="White"  />
                            <asp:TemplateField  ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="40px">
                             <ItemTemplate>
                                 <asp:ImageButton   ID="ImgVisualiser" ImageUrl="~/Icons/chauffeur_Historique.png"   CssClass="button"  ToolTip="Détails Chauffeur" runat="server"   CommandName="Visualiser" > </asp:ImageButton>
                           </ItemTemplate>
                             </asp:TemplateField>
                            <asp:TemplateField HeaderText="Pointage  "  FooterStyle-HorizontalAlign="Center"  ItemStyle-HorizontalAlign="Center"  SortExpression ="Instant" >
                            ...
                            <asp:TemplateField HeaderText="CIN  " ItemStyle-HorizontalAlign="Center" SortExpression="Reference" >
                                <ItemTemplate><asp:Label ID="Reference" runat="server" Text='<%# Eval("Reference") %>'></asp:Label></ItemTemplate>
                            </asp:TemplateField >

                           <asp:TemplateField HeaderText="Nom  " HeaderStyle-Width="150px"  SortExpression="Nom">
                                <ItemTemplate><asp:Label ID="Nom" runat="server" Text='<%# Eval("Nom")%>'></asp:Label></ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="Prénom  " SortExpression="Prenom" FooterStyle-HorizontalAlign="Right">
                                <ItemTemplate><asp:Label ID="Prenom" runat="server" Text='<%# Eval("Prenom") %>'></asp:Label></ItemTemplate>
                                 <FooterTemplate >
                         ...
                         <asp:Button id="BtnPrevious" runat="server" Text="&#9664;" CssClass="text" ToolTip="Page Précédente" OnClick="BtnPrevious_Click" />
                            ...
                            <asp:TemplateField HeaderText="N° Permis  " ItemStyle-HorizontalAlign="Center" SortExpression="NumBadge" FooterStyle-HorizontalAlign="Left">
                                <ItemTemplate><asp:Label ID="NumBadge" runat="server" Text='<%# Eval("NumBadge") %>'></asp:Label>
                                </ItemTemplate>
                                <FooterTemplate >
                            ...
                            <asp:TemplateField HeaderText="Immatriculation  "  ItemStyle-HorizontalAlign="Center"    SortExpression="Immatriculation">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Code Refus  "  ItemStyle-HorizontalAlign="Center"  SortExpression="CodeRefus">
                                <ItemTemplate><asp:Label ID="CodeRefus" runat="server" Text='<%# Eval("CodeRefus") %>'></asp:Label></ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="Libellé Code Refus  "  ItemStyle-HorizontalAlign="Center"  SortExpression="CodeRefus">
                                <ItemTemplate><asp:Label ID="LibelleCode" runat="server" Text='<%# Eval("LibelleCode") %>'></asp:Label></ItemTemplate>
                            </asp:TemplateField>

                            
                            <asp:TemplateField HeaderText="Borne  "  SortExpression="NumLecteur" >
                                <ItemTemplate><asp:Label ID="NomLecteur" runat="server" Text='<%# Eval("NomLecteur") %>'></asp:Label></ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="Mode Ptge  "  ItemStyle-HorizontalAlign="Center" >
                                <ItemTemplate><asp:Label ID="ModePointage" runat="server" Text='<%# Eval("LibelleModePointage") %>'></asp:Label></ItemTemplate>
                            </asp:TemplateField>
                            
                           
                            <asp:TemplateField HeaderText="Matricule Agent  "   ItemStyle-HorizontalAlign="Center"  SortExpression="MatriculeAdmin">
                                <ItemTemplate><asp:Label ID="MatriculeAdmin" runat="server" Text='<%# Eval("MatriculeAdmin") %>'></asp:Label></ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="Nom Agent  "  SortExpression="NomAgent">
                                <ItemTemplate><asp:Label ID="NomAgent" runat="server" Text='<%# Eval("NomAgent") %>'></asp:Label></ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="Prénom Agent  "  SortExpression="PrenomAgent">
                                <ItemTemplate><asp:Label ID="PrenomAgent" runat="server" Text='<%# Eval("PrenomAgent") %>'></asp:Label></ItemTemplate>
                            </asp:TemplateField>
        ...
        <asp:UpdatePanel ID="UpdatePanel4" runat="server">
            <ContentTemplate>
                <fieldset style="text-align:center;">
                    <asp:Image ID="photo" runat="server" Height="280px" ImageAlign="Middle" 
                        ImageUrl="~/icons/Inconnu.jpg" Width="90%" />
                </fieldset>
                <table>
                    <tr>
