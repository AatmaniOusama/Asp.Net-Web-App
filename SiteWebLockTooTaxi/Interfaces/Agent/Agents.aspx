<%@ Page Title="Agents" Language="C#" MasterPageFile="~/Interfaces/Shared/MasterPage.master"
    AutoEventWireup="true" CodeFile="Agents.aspx.cs" Inherits="Agent_index" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <asp:Table ID="BarreControle" runat="server" CellPadding="5">
        <asp:TableRow VerticalAlign="Bottom">
            ...
            <asp:TableCell>
                <asp:ImageButton ID="BtnAdd" ImageUrl="~/Icons/add_Agent.png" runat="server" CssClass="button"
                    ToolTip="Ajouter" OnClick="BtnAdd_Click" />
            </asp:TableCell>
            <asp:TableCell>
                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:ImageButton ID="BtnSet" ImageUrl="~/Icons/modifier_Agent.png" runat="server"
                            CssClass="button" ToolTip="Modifier" OnClick="BtnSet_Click" Visible="false" />
                    </ContentTemplate>
                    <Triggers>
            ...
            <asp:TableCell>
                <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:ImageButton ID="BtnDelete" ImageUrl="~/Icons/delete_Agent.png" runat="server"
                            CssClass="button" ToolTip="Supprimer" OnClick="BtnDelete_Click" OnClientClick="return confirm('Etes-vous sûr que vous voulez supprimer cet agent ?');"
                            Visible="false" />
                    </ContentTemplate>
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="GridViewAgents" EventName="SelectedIndexChanging" />
            ...
            <asp:TableCell>
                <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:ImageButton ID="BtAutoriser" ImageUrl="~/Icons/autoriser_Agent.png" runat="server"
                            CssClass="button" ToolTip="Autoriser" OnClick="BtAutoriser_Click" Visible="false" />
                        <asp:ImageButton ID="BtInterdire" ImageUrl="~/Icons/Interdire_Agent.png" runat="server"
                            CssClass="button" ToolTip="Interdire" OnClick="BtInterdir_Click" Visible="false" />
                    </ContentTemplate>
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="GridViewAgents" EventName="SelectedIndexChanging" />
                        <asp:AsyncPostBackTrigger ControlID="GridViewAgents" EventName="RowDataBound" />
            ...
            <asp:TableCell>
                <asp:UpdatePanel ID="UpdateLecteurNowPanel" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:ImageButton ID="BtnUpdateLecteurNow" ImageUrl="~/Icons/EnvoieAuLecteur.jpg"
                            runat="server" CssClass="button" ToolTip="Envoie aux bornes de pointages" OnClick="BtnUpdateLecteurNowClick"
                            OnClientClick="return confirm('Mettre à jour immédiatement ce chauffeur dans les bornes de pointages');"
                            Visible="false" />
                    </ContentTemplate>
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="GridViewAgents" EventName="SelectedIndexChanging" />
            ...
            <asp:Panel ID="Panelfilter" runat="server" Visible="true" Style="width: 100%; height: 95px;">
                ...
                <fieldset style="width: 98%; height: 65%;">
                    ...
                    <table style="width: 1174px">
                        ...
                        <tr>
                            <td>
                                <asp:TextBox ID="TbMatricule" runat="server" CssClass="text" AutoPostBack="true"
    ...
    <asp:UpdatePanel runat="server" ID="UpdatePanel" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:GridView ID="GridViewAgents" CssClass="GridViewStyle" runat="server" AutoGenerateColumns="False"
                ShowFooter="true" ShowHeaderWhenEmpty="true" AllowSorting="True" OnSorting="agents_Sorting"
                OnRowCommand="ImgVisualiser_Click" OnRowDeleting="GridViewAgents_RowDeleting"
                OnPageIndexChanging="GridViewAgents_IndexChanging" OnRowDataBound="GridViewAgents_RowDataBound"
                ...
                <Columns>
                    <asp:ButtonField Text="" CommandName="Select" HeaderStyle-Width="0px" HeaderStyle-BackColor="White"
                        HeaderStyle-BorderColor="White" ItemStyle-Width="0px" ItemStyle-BackColor="White"
                    ...
                    <asp:TemplateField HeaderText="Matricule  " HeaderStyle-Width="18%" SortExpression="Matricule"
                        ControlStyle-Height="25" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Prénom  " FooterStyle-HorizontalAlign="Right" SortExpression="Prenom"
                        HeaderStyle-Width="20%" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Date Début  " FooterStyle-HorizontalAlign="Left" HeaderStyle-Width="20%"
                        SortExpression="DateDebut" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Date Fin  " HeaderStyle-Width="20%" SortExpression="DateFin"
