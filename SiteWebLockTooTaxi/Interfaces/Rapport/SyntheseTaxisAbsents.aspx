<%@ Page Title="Synthèse des Taxis Absents" Language="C#" MasterPageFile="~/Interfaces/Shared/MasterPage.master" AutoEventWireup="true" CodeFile="SyntheseTaxisAbsents.aspx.cs" Inherits="Interfaces_Rapport_SyntheseControles" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
     ...
     <asp:Table ID="BarreControle" runat="server" CellPadding="5">
            ...
            <asp:TableCell>
                 <asp:ImageButton ID="BtPrint"  ImageUrl="~/Icons/Print.jpg" runat="server" CssClass="button"  ToolTip="Imprimer"  onClick="btnPrint_Click" />                          
            </asp:TableCell>
    ...
    <asp:UpdatePanel ID="UpdatePanel_Filter" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
           <asp:Panel  id="Panelfilter" runat="server" Visible="true" style="width:99.4%;height:70px; margin-left:8px;">
            ...
            <asp:Table ID="Table_Filter" runat="server" Height="34px"  Width="959px" >
                    <asp:TableRow >
                        <asp:TableCell>
                            Date du jour
                        </asp:TableCell>
...
<asp:ListItem Value="3"> 08h -> 21h </asp:ListItem>
                      ...
                      <asp:TableCell>&nbsp;
                          <asp:TextBox ID="TbNbrLignes" runat="server"  AutoPostBack="true" Width="59px" BackColor="Black" Font-Bold="True" ForeColor="White"  CssClass="text" ReadOnly="true" ></asp:TextBox>  
  ...
  TAXIS       
    ...
    <asp:UpdatePanel ID="UpdatePanel_Table" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:Panel ID="Panel1" runat="server" ScrollBars="Vertical"  Height="608px" >
